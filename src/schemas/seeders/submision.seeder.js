...

{
  ...
  child: {
      ...
      age: 2,
      year_of_life: 3,
      childAddress: 'calle 16 #5120 entre 51 y 53',
...
// Submision 2 data
{
  ...
  child: {
      ...
      age: 1,
      year_of_life: 2,
      childAddress: 'calle 4 #4B entre E y 3',
...
// Submision 3 data
{
  ...
  child: {
    ...
    age: 1,
    year_of_life: 2,
    childAddress: 'calle 16 #5122 entre 51 y 53',
    neighborhood: 'Abel Santamaria',
    cPopular: 'Abel Santamaria',
    municipality: 'Isla de la Juventud',
    province: 'Isla de la Juventud',
...
// Submision 4 data
{
  ...
  child: {
    ...
    age: 1,
    year_of_life: 2,
    childAddress: 'calle E #568 entre 4b y D',
    neighborhood: 'Micro 70',
    cPopular: 'Micro 70',
    municipality: 'Isla de la Juventud',
    province: 'Isla de la Juventud',
